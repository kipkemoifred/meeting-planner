...
//    }
   ...
   public List<User> getUsers(){
    ...
    public User addUser(User user){
        userRepository.save(user);
        //get email of user and send mail


        String setPasswordLink="http://localhost:8080/api/setPassword";
        String emailName=user.getEmail();
        //post new pd

        sendEmailService.sendEmail(emailName,
                " the link to set password is "+setPasswordLink,"Set password");
